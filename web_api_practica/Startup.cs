...
using practica_entrega.Services;

namespace practica_entrega
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient((ServiceProvider) => BridgeDBConnection<UserModel>.Create(Configuration.GetConnectionString("LocalServer"), practica_2_nuguets.Models.DbEnum.Sql));
            services.AddTransient((ServiceProvider) => BridgeDBConnection<LoginModel>.Create(Configuration.GetConnectionString("CloudServer"), practica_2_nuguets.Models.DbEnum.Sql));
